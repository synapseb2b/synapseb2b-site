    ...
    <section className="relative py-24 md:py-32 pt-36 md:pt-44 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 md:px-16 lg:px-24">
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.08] text-white max-w-3xl mb-6"
          >
            {"Vamos conversar sobre "}
            <span className="text-primary">sua receita.</span>
          </motion.h1>

// pages/casos-de-uso.js (VERSÃO REVISADA SEM IMAGENS E COM PADDING CORRIGIDO)

import Head from 'next/head';
import Link from 'next/link';
import { useState, useEffect } from 'react';
import { ArrowRight, Wrench, HeartPulse } from 'lucide-react';
...
export default function CasosDeUsoPage() {
  ...
  return (
    <>
      <Head>
        <title>Casos de Uso | Engenharia de Receita B2B na Prática - Synapse B2B</title>
        ...
        <div className="container hero-content text-center page-hero-padding">
          <div className="reveal-up">
            ...
            <p className="hero-subheadline">
              A prova da nossa engenharia não está no que dizemos, mas no valor que desbloqueamos. Analise a anatomia de duas transformações de Go-To-Market e veja o Cortex GTM™ em ação.
            </p>
          </div>
        </div>
      </section>

      <section id="introducao" className="section-solid">
        <div className="container text-center reveal-up">
          <h2 className="section-title">A Prova da Engenharia.</h2>
          <p className="lead-text">
            Cada cliente que nos procura enfrenta uma variação do mesmo desafio: o Paradoxo do Valor, onde a genialidade técnica não se converte em performance de mercado. Abaixo, não apresentamos "cases", mas sim o blueprint de como nosso sistema de engenharia decodifica a complexidade e arquiteta um novo motor de receita.
          </p>
        </div>
      </section>

      {/* Layout principal para os estudos de caso */}
      <div className="case-studies-container">
        {/* Estudo de Caso 1: Engenharia & Indústria */}
        <section id="case-1" className="section-with-gradient-glow">
          <div className="container reveal-up">
            <div className="case-study-header text-center">
              <Wrench className="case-study-icon" />
        ...
        {/* Estudo de Caso 2: HealthTech */}
        <section id="case-2" className="section-solid">
          <div className="container reveal-up">
            <div className="case-study-header text-center">

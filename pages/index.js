      ...
      <section className="hero-section">
        ...
        <div className="container hero-content text-center page-hero-padding reveal-up">
          ...
          <p className="hero-subheadline wider-on-desktop">
            Assessoria de Engenharia de Receita que transforma produtos complexos em ofertas que o mercado entende, compra e escala — com 20+ anos de experiência operacional em ecossistemas B2B.
          </p>
